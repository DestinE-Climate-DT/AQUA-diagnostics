...
class TestSeaIce:
    ...
    def test_seaice_compute_with_std(
        self, method, region, value, expected_units, variable, calc_std_freq, expect_exception, error_message
    ):
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "extent", "arctic", "siconc", 21.4141,
                {"calc_std_freq": "monthly", "get_seasonal_cycle": True},
                ["variable", "month"],
            ),
            (
                "extent", "antarctic", "siconc", 3.2294,
                {"calc_std_freq": "monthly", "get_seasonal_cycle": True},
                ["variable", "month"],
            ),
        ],
