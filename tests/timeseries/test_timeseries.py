...
class TestTimeseries:
    ...
    def test_all_freq_with_region(self, tmp_path):
        ...
        filename = (
            f"{self.diagnostic_name}.timeseries."
        ...
        plt = PlotTimeseries(
            diagnostic_name=self.diagnostic_name,
            monthly_data=ts.monthly,
            annual_data=ts.annual,
            ref_monthly_data=ts.monthly,
            ref_annual_data=ts.annual,
            std_monthly_data=ts.std_monthly,
            std_annual_data=ts.std_annual,
            loglevel=loglevel,
        )
