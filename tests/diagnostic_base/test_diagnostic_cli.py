...
class TestDiagnosticCLI:
    ...
    def test_dataset_args_uses_defaults(self, mock_args):
        ...
        dataset = {"catalog": "my-catalog", "model": "MyModel", "exp": "historical", "source": "CMIP6"}
    ...
    def test_custom_log_name(self, mock_args):
        ...
        cli = DiagnosticCLI(
            args=mock_args, diagnostic_name="test_diagnostic", default_config="config_test.yaml", log_name="CustomLogger"
        )
