...
def parse_arguments(args):
    ...
    parser.add_argument("--source2d", type=str, help="2d source name", required=False)
    parser.add_argument("--source3d", type=str, help="3d source name", required=False)
    parser.add_argument("--outputdir", type=str, help="full res output directory", required=False)
