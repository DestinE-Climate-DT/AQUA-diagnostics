...
def parse_arguments(args):
    ...
    parser.add_argument("--regrid", type=str, help="regrid value", required=False)
    parser.add_argument("--realization", type=str, default=None, help="realization name (default: None)")
    parser.add_argument("--freq", type=str, help="frequency", required=False)
    parser.add_argument("--outputdir", type=str, help="output directory", required=False)
    parser.add_argument("--bufferdir", type=str, help="buffer directory", required=False)
    parser.add_argument("--xmax", type=int, help="maximum value on horizontal axe", required=False)
    parser.add_argument("--nproc", type=int, required=False, help="the number of processes to run in parallel", default=4)
