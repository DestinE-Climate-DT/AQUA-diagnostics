                ...
                for region in regions:
                    try:
                        ...
                        run_args = {
                            "var": var,
                            "formula": False,
                            "long_name": var_config.get("long_name"),
                            "units": var_config.get("units"),
                            "short_name": var_config.get("short_name"),
                            "freq": var_config.get("freq"),
    ...
    if "gregory" in cli.config_dict["diagnostics"]:
        if cli.config_dict["diagnostics"]["gregory"]["run"]:
            ...
            try:
                ...
                run_args = {
                    "freq": freq,
                    "t2m_name": cli.config_dict["diagnostics"]["gregory"].get("t2m_name", "2t"),
                ...
                if cli.config_dict["diagnostics"]["gregory"]["std"]:
                    # t2m:
                    dataset_args = {
                        **cli.config_dict["diagnostics"]["gregory"]["t2m_ref"],
                        "regrid": cli.regrid,
                    ...
                    # net_toa:
                    dataset_args = {
                        **cli.config_dict["diagnostics"]["gregory"]["net_toa_ref"],
                        "regrid": cli.regrid,
                        "startdate": cli.config_dict["diagnostics"]["gregory"].get("std_startdate"),
                        "enddate": cli.config_dict["diagnostics"]["gregory"].get("std_enddate"),
                    }
