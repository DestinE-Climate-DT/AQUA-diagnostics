...
class PlotEnsembleTimeseries(BaseMixin):
    ...
    def plot(
        ...
        Args:
            ...
            startdate (str, optional): Start date for the timeseries plot. Auto-derived if None. Defaults to None.
            enddate (str, optional): End date for the timeseries plot. Auto-derived if None. Defaults to None.
            ...
            monthly_data (xr.Dataset, optional): Monthly ensemble members concatenated along the ensemble dimension. Defaults to None.
            monthly_data_mean (xr.Dataset, optional): Monthly ensemble mean timeseries. Defaults to None.
            monthly_data_std (xr.Dataset, optional): Monthly ensemble standard deviation timeseries. Defaults to None.
            annual_data (xr.Dataset, optional): Annual ensemble members concatenated along the ensemble dimension. Defaults to None.
            ...
            save_format (str or list, optional): Format(s) to save the figure in (e.g. 'png', 'pdf', 'svg'). Defaults to SAVE_FORMAT.
            ...
            plot_ensemble_members (bool, optional): If True, plots the individual ensemble members. Defaults to True.
