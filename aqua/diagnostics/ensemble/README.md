...
- [Example of how to use the 2D Maps (lon-lat) ensemble of atmglobalmean](https://github.com/DestinE-Climate-DT/AQUA/blob/main/notebooks/diagnostics/ensemble/ensemble_global_2D.ipynb)
